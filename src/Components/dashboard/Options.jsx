              ...
              <form className="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
                ...
                {modalType===0? <FolderDropdown changeFolder={changeFolder}></FolderDropdown>: <div>
                  ...
                  <input value={newFolderName} onChange={(e)=>{
                    setFolderName(e.target.value);
                  }} type="text" name="folder_name" id="folder_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Folder Name" required />
                </div>}
               
               
                
                <button type="button" className="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={changeFolder}>Done</button>
