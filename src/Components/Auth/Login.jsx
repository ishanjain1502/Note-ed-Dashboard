                        ...
                        <form className="mt-8 space-y-6" action="#" method="POST">
                            ...
                            <div>
                                <button
                                    type="submit"
                                    onClick={loginUser}
                                    className="font-custom group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-custom hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                >
